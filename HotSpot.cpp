...
void CHotSpotWeenie::DoCycleDamage(CWeenieObject *other)
{
	...
	damageEvent.outputDamage = damageEvent.inputDamage = (int)(m_Qualities.GetInt(DAMAGE_INT, 0) * (1.0 - (Random::GenFloat(0.0f, m_Qualities.GetFloat(DAMAGE_VARIANCE_FLOAT, 0.0)))));
