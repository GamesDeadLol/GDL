...
LRESULT CALLBACK AboutProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_INITDIALOG:
		SetWindowText(GetDlgItem(hDlg, IDC_CREDITS), "GamesDeadLol Server " SERVER_VERSION_NUMBER_STRING "\n" SERVER_VERSION_STRING "\nhttps://github.com/GamesDeadLol/GDL\n\nOriginally created by Pea in C++ and halted in September 2017. Third-party libraries used include zlib, SHA512 and ISAAC algorithms.");
	...
	case WM_INITDIALOG:
		{
			...
			SetWindowText(hVersion, "GamesDeadLol Server " SERVER_VERSION_NUMBER_STRING " " SERVER_VERSION_STRING); // "PhatAC compiled " __TIMESTAMP__);
	...
	int       nCmdShow)
{
	...
	LOG(UserInterface, Normal, "Welcome to GamesDeadLol..\n");
