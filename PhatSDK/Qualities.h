...
{
	long double rRawValue = 0.0;
	long double rValueIncreasingMultiplier = 0.0;
	long double rValueDecreasingMultiplier = 0.0;
	long double rValueIncreasingAdditive = 0.0;
	long double rValueDecreasingAdditive = 0.0;
};
