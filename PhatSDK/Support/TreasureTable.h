...
public:
	...
	int RollPaletteTemplateIDFromMaterialAndColorCode(MaterialType baseMaterial, int colorCode, int tier);
	...
	PackableHashTable<DWORD, PackableList<TreasureEntry>> _wieldedTreasure; // hashA
	PackableHashTable<DWORD, TreasureEntry2> _treasure2; // hashB
